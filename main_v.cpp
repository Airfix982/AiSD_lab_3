    ...
    while( 1 )
    {
        ...
        if ( choosen_data_type == 1 )
        {
            ...
            while ( true )
            {
                ...
                bool flag_2 = 1;
                set_of_numbers<int> set_1;//-------------------------------------
                set_of_numbers<int> set_2;//-------------------------------------
        ...
        if ( choosen_data_type == 2 )
        {
            ...
            while ( true )
            {
                ...
                bool flag_1 = 1;
                bool flag_2 = 1;
                set_of_numbers<float> set_1;//-------------------------------------
                set_of_numbers<float> set_2;//-------------------------------------
        ...
        if ( choosen_data_type == 3 )
        {
            ...
            while (true)
            {
                ...
                bool flag_1 = 1;
                bool flag_2 = 1;
                set_of_numbers<string> set_1;//-------------------------------------
                set_of_numbers<string> set_2;//-------------------------------------
        ...
        if (choosen_data_type == 4)
        {
            ...
            while (true)
            {
                ...
                bool flag_1 = 1;
                bool flag_2 = 1;
                set_of_numbers<pair<int, double>> set_1;//-------------------------------------
                set_of_numbers<pair<int, double>> set_2;//-------------------------------------
                ...
                while (true)
                {
                    try
                    {
                        ...
                        if (double(int(size_1)) != size_1) throw "wrong size ";
                        set_of_numbers<pair<int, double>> set_3;//-------------------------------------
                        for (int j = 0; j < size_1; j++)
                        {
                        ...
                        if (double(int(size_2)) != size_2) throw "wrong size ";
                        set_of_numbers<pair<int, double>> set_4;//-------------------------------------
                        for (int i = 0; i < size_2; i++)
                        {
